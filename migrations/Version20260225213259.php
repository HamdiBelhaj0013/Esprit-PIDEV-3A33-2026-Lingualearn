 ...
 */
final class Version20260225213259 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, contenu_c LONGTEXT NOT NULL, date_com DATETIME DEFAULT NULL, publication_id INT NOT NULL, INDEX IDX_67F068BC38B217A7 (publication_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE publication (id INT AUTO_INCREMENT NOT NULL, titre_pub VARCHAR(255) NOT NULL, type_pub VARCHAR(255) NOT NULL, lien_pub VARCHAR(255) NOT NULL, contenu_pub LONGTEXT NOT NULL, date_pub DATETIME NOT NULL, likes INT NOT NULL, dislikes INT NOT NULL, report_pub INT DEFAULT NULL, floue INT DEFAULT NULL, user_id INT NOT NULL, INDEX IDX_AF3C6779A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
