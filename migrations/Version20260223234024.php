 ...
 */
final class Version20260223234024 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercice ADD CONSTRAINT FK_E418C74D853CD175 FOREIGN KEY (quiz_id) REFERENCES quiz (id)');
