 ...
 */
final class Version20260225204103 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercice ADD difficulty SMALLINT DEFAULT 3 NOT NULL, CHANGE options options JSON NOT NULL, CHANGE skill_codes skill_codes JSON DEFAULT \'[]\' NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercice DROP difficulty, CHANGE options options LONGTEXT NOT NULL COLLATE `utf8mb4_bin`, CHANGE skill_codes skill_codes LONGTEXT NOT NULL COLLATE `utf8mb4_bin`');
        $this->addSql('ALTER TABLE exercise_ai_feedback CHANGE model model VARCHAR(120) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE faq CHANGE subject subject VARCHAR(50) DEFAULT \'NULL\', CHANGE category category VARCHAR(50) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE learning_stats CHANGE last_study_session last_study_session DATETIME DEFAULT \'NULL\'');
