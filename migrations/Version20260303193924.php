 ...
 */
final class Version20260303193924 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire CHANGE date_com date_com DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE exercice ADD difficulty SMALLINT DEFAULT 3 NOT NULL, ADD skill_codes JSON DEFAULT \'[]\' NOT NULL, CHANGE options options JSON NOT NULL');
        ...
        $this->addSql('ALTER TABLE publication CHANGE lien_pub lien_pub VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE quiz ADD difficulty SMALLINT DEFAULT 3 NOT NULL, ADD skill_codes JSON DEFAULT \'[]\' NOT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire CHANGE date_com date_com DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE exercice DROP difficulty, DROP skill_codes, CHANGE options options LONGTEXT NOT NULL COLLATE `utf8mb4_bin`');
        $this->addSql('ALTER TABLE exercise_ai_feedback CHANGE model model VARCHAR(120) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE faq CHANGE subject subject VARCHAR(50) DEFAULT \'NULL\', CHANGE category category VARCHAR(50) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE learning_stats CHANGE last_study_session last_study_session DATETIME DEFAULT \'NULL\'');
        ...
        $this->addSql('ALTER TABLE publication CHANGE lien_pub lien_pub VARCHAR(255) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE quiz DROP difficulty, DROP skill_codes, CHANGE created_at created_at DATETIME DEFAULT \'NULL\', CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE quiz_attempt CHANGE finished_at finished_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE reclamation CHANGE sla_deadline sla_deadline DATETIME DEFAULT \'NULL\', CHANGE resolved_at resolved_at DATETIME DEFAULT \'NULL\', CHANGE satisfaction_rated_at satisfaction_rated_at DATETIME DEFAULT \'NULL\'');
